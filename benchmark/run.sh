...
if [[ "$RUN_AC2" -eq "1" ]]; then
   ...
   RunAC2  "-l 1 -lr 0.15 -hs 16" "EP"
   RunAC2  "-l 1 -lr 0.07 -hs 16" "XV"
   RunAC2  "-l 2 -lr 0.05 -hs 48" "FV"
   RunAC2  "-l 7 -lr 0.02 -hs 48" "FM"
   RunAC2  "-l 2 -lr 0.04 -hs 64" "HA"
   RunAC2  "-l 5 -lr 0.03 -hs 48" "AP"
   RunAC2  "-l 4 -lr 0.02 -hs 48" "DA"
   RunAC2  "-l 4 -lr 0.02 -hs 48" "MJ"
   RunAC2  "-l 4 -lr 0.03 -hs 48" "HI"
   RunAC2  "-l 5 -lr 0.02 -hs 40" "SA"
   RunAC2  "-l 5 -lr 0.02 -hs 40" "LC"
