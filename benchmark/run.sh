...
if [[ "$RUN_AC2" -eq "1" ]]; then
   ...
   RunAC2  "-l 1 -lr 0.2 -hs 16" "EP"
   RunAC2  "-l 1 -lr 0.2 -hs 16" "XV"
   RunAC2  "-l 2 -lr 0.05 -hs 24" "FV"
   RunAC2  "-l 7 -lr 0.5 -hs 48" "FM"
   RunAC2  "-l 2 -lr 0.12 -hs 24" "HA"
   RunAC2  "-l 5 -lr 0.4 -hs 40" "AP"
   RunAC2  "-l 4 -lr 0.4 -hs 40" "DA"
   RunAC2  "-l 4 -lr 0.3 -hs 40" "MJ"
   RunAC2  "-l 4 -lr 0.5 -hs 40" "HI"
   RunAC2  "-l 5 -lr 0.4 -hs 48" "SA"
   RunAC2  "-l 5 -lr 0.4 -hs 64" "LC"
   RunAC2  "-l 5 -lr 0.4 -hs 64" "EC"
   RunAC2  "-l 7 -lr 0.17 -hs 64" "HT"
